...
import { CheckCircle, AlertTriangle, Upload, Mail, Shield, HelpCircle, User, ChevronLeft } from "lucide-react"

export function UnifiedSettings() {
  const [userType, setUserType] = useState<"creator" | "buyer">("creator") // This would come from auth context
  ...
  return (
    <div className="max-w-4xl mx-auto p-12">
      <div className="mb-6">
        <Link
          href={userType === "creator" ? "/creator-dashboard" : "/dashboard"}
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Manage your {userType === "creator" ? "creator" : "viewer"} account and preferences.
        </p>
      </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  <Label htmlFor="displayName">Display name {userType === "creator" && "(public)"}</Label>
                  <Input
                    id="displayName"
                    value={displayName}
                  ...
                  <p className="text-sm text-muted-foreground">
                    {userType === "creator"
                      ? "This name appears on your Shots and storefront."
                      : "This is how you'll appear in comments and interactions."}
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  <p className="text-sm text-muted-foreground">
                    {userType === "creator"
                      ...
                      : "If you need help with your account or want to delete it, contact our support team."}
                  </p>
